  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
    ...
    if ( strncmp(line, "box", strlen(line)) == 0 ) {
      ...
      add_box(polygons, xvals[0], yvals[0], zvals[0],
	      xvals[1], yvals[1], zvals[1]);
      matrix_mult( stacker->data[stacker->top],polygons );
      ...
      matrix_mult(stacker->data[stacker->top],edges);
	...
	type = BEZIER;
      ...
      matrix_mult(stacker->data[stacker->top],tmp);
      stacker->data[stacker->top] = tmp;
    }//end scale
